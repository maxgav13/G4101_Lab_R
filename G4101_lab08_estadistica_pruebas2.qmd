...
aov.omega = omega_f(dfm = 2, dfe = 9, Fvalue = 10.8, n = 12, a = alfa)
...
# MOTE
aov.eta = eta_f(dfm = 2, dfe = 9, Fvalue = 10.8, a = alfa)
...
```{r}
# MOTE
v.gof = v_chi_sq(x2 = CHI.gof$statistic, n = N.gof, 
...
```{r}
# MOTE
v.h = v_chi_sq(x2 = CHI.h$statistic, n = N.h, 
...
```{r}
# MOTE
v.i = v_chi_sq(x2 = CHI.i$statistic, n = N.i, 
