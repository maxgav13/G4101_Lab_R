...
$$
g = d \cdot \Big(1-\frac{3}{4 \cdot v-1}\Big)
$$
...
$$
d = \frac{\bar{x}_1 - \bar{x}_2}{\sqrt{\frac{s_1^2(n_1-1)+s_2^2(n_2-1)}{n_1+n_2-2}}}
$$

Correcion

$$
g = d \cdot \Big(1-\frac{3}{4 \cdot v-1}\Big) = d \cdot \Big(\frac{N-3}{N-2.25}\Big)
$$
