...
ggplot(datos, aes_string(myvar0)) + 
...
show.vgms(models = c('Sph','Pen','Cir','Exp','Gau'),
  ...
  theme(legend.position = c(.8,.5), 
        legend.background = element_rect('white',size = .2)) + 
...
rgdal::writeGDAL(ok_sp[pred.var], 'figs/krige_pred.tif')
rgdal::writeGDAL(ok_sp[var.var], 'figs/krige_var.tif')
```
