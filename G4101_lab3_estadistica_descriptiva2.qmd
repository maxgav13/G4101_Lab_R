...
En una regresion simple (y ~ x, un predictor) el coeficiente de correlacion (y covarianza) entre ambas variables va a ser igual a la pendiente de la regresion cuando se usan variables estandarizadas ($z \sim N(0,1)$) o se estandariza el modelo con las variables originales.
