...
rmse(mod2) # error del modelo lineal
rmse(mod3) # error del modelo cuadratico
sjstats::cv(mod2) # coef var modelo lineal
sjstats::cv(mod3) # coef var modelo cuadratico

anova(mod2,mod3) # comparacion de modelos

comp.mods = compare_performance(mod2,mod3,rank = T) # performance
comp.mods
plot(comp.mods)

modelsummary(list(Lineal=mod2,Cuadratico=mod3),
...
sjPlot::plot_models(mod2,mod3,
                    std.est = NULL, # 'std', NULL
                    show.values = T,
                    show.p = T,
                    m.labels = c('Lineal','Cuadrático'),
                    legend.title = 'Modelo')

ggstatsplot::ggcoefstats(mod3,exclude.intercept = T)
