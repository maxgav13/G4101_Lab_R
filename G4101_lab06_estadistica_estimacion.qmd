...
interval_var1(x = vec, alpha = alfa) # OneTwoSamples
...
# interval_estimate1(x = vec, sigma = sigma, alpha = alfa) # OneTwoSamples
...
interval_estimate1(x = vec, alpha = alfa) # OneTwoSamples
...
interval_estimate2(x = A, y = B, var.equal = T, alpha = a) # OneTwoSamples
...
```{r}
interval_estimate2(x = A, y = B, var.equal = F, alpha = a) # OneTwoSamples
...
interval_estimate1(x = diferencia, alpha = a) # OneTwoSamples
