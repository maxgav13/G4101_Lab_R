...
getwd()
setwd("~/Documents/UCR/Docencia/G 4101 - Geologia Numerica/")
```
...
dat1 <- rio::import("data/LungCapData2.csv")
titanic <- rio::import("data/titanic.csv")
```
...
ggplot(airquality,aes(x=Temp)) +
  geom_histogram(bins = 20,aes(y=after_stat(density)),col="black",fill="blue")
