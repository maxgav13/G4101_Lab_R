...
theme_set(theme_minimal(base_family = 14))
```
...
```{r}
theta0 = c(255, 239, 222, 231, 199, 271, 222, 274, 228, 246, 177, 199, 
          257, 201, 237, 209, 216, 180, 182, 250, 219, 196, 197, 246, 
          218, 235, 232, 243, 232, 180, 231, 254, 242, 149, 212, 210, 230, 205, 220, 268)
```

## Ajusta angulos para datos no-direccionales
...
$$H_0: k = 0, \ los \ datos \ siguen \ una \ distribucion \ aleatoria$$
...
(fcrit = qf(1-a,1,length(thetaall)-2))
f > fcrit
```
